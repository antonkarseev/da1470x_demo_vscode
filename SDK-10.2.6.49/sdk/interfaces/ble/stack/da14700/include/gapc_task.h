...
//5.0 CH2
    ...
    /// Set peripheral skip latency for connection
    GAPC_SET_SKIP_LATENCY_CMD,
...
enum gapc_operation
{
    ...
    /// Set skip latency for a connection
    GAPC_SET_SKIP_LATENCY,
...
/// Parameters of the @ref GAPC_SET_SKIP_LATENCY_CMD message
struct gapc_set_skip_latency_cmd
{
        /// GAP request type:
        /// - GAPC_SET_SKIP_LATENCY : Set skip latency
        uint8_t operation;
        /// On/Off
        uint8_t enable;
};
