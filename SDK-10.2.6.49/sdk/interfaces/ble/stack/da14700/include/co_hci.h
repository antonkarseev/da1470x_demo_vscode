...
#define HCI_DBG_LE_SET_SKIP_PERIPHERAL_LATENCY_ENABLE_CMD_OPCODE   0xFC47
...
///HCI Debug Set Skip Peripheral Latency Enable command
struct hci_dbg_le_set_skip_peripheral_latency_enable_cmd
{
    /// Connection handle
    uint16_t       conhdl;
    /// Skip latency enabled
    uint8_t        enable;
};
#else
