...
/* USB system version */
#define USB_VERSION  33601uL // Format: Mmmrr Example: 33403uL is 3.34.3
...
#else
  #ifdef _lint
    //lint -emacro({717,9036}, USB_PANIC)  N:100
...
#else
  #ifdef _lint
    //lint -emacro({717}, USB_WARN)  N:102
