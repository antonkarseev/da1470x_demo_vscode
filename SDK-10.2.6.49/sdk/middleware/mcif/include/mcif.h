...
/**
 * \brief MCIF ASCII flags mask value
 */
#define MCIF_ASCII_FLAGS_MASK 0x3

/** @name ASCII command-set argument X not-applicable flag
 *
 ...
 */
///@{
/** When this flag is set on a command,
 * then this command does not accept an argument
 */
...
/** @name ASCII command-set integer argument X
 *
...
///@{
/** When this flag is set on a command,
 * then the argument is expected to be an integer.
 */
...
/** @name ASCII command-set string argument X
 *
 * When this flag is set on a command, argument X of the command
...
///@{
/** When this flag is set on a command,
 * then the argument is expected to be a string.
 */
...
/** @name ASCII command-set string with no whitespace argument X
 *
 * When this flag is set on a command, argument X of the command
...
///@{
/** When this flag is set on a command,
 * then the argument is expected to be a string with no whitespaces.
 */
...
//! @cond Doxygen_Suppress_Warning_For_Callback
#if MCIF_MAX_ARGS > 2
