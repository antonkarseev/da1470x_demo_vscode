 ...
 *
 * \brief Crypto adapter - AES/HASH and ECC engines
 *
 ...
 * the \link AES_HASH AES hash engine documentation \endlink and in the ECC engine
 * documentation.
 *
...
#if dg_configUSE_HW_AES_HASH || dg_configUSE_HW_AES || dg_configUSE_HW_HASH
...
#endif /* dg_configUSE_HW_AES_HASH || dg_configUSE_HW_AES || dg_configUSE_HW_HASH */
