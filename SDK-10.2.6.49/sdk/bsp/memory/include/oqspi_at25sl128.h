 ...
 ****************************************************************************************
 *
 * @file oqspi_at25sl128.h
 *
 * @brief OQSPI flash driver for Renesas AT25SL128
 *
 ...
 ****************************************************************************************
 */
#ifndef _OQSPI_AT25SL128_H_
#define _OQSPI_AT25SL128_H_
...
#define OQSPI_AT25SL128_DENSITY (0x18)

/* Flash power up/down timings in usec */

#define AT25SL128_READ_CS_IDLE_DELAY_NS       70   // tCSH
#define AT25SL128_ERASE_CS_IDLE_DELAY_NS      100   // tCSH
#define AT25SL128_SUSPEND_LATENCY_US          30    // tSUS
#define AT25SL128_RESUME_LATENCY_US           3     // tRES
#define AT25SL128_RES_SUS_LATENCY_US          64     // tSUS  100 ns
#define AT25SL128_RESET_DELAY_US              30    // tRST/tSWRST
#define AT25SL128_POWER_DOWN_DELAY_US         3     // tDP/tEDPD
#define AT25SL128_RELEASE_POWER_DOWN_DELAY_US 3     // tRES1/tRDPD
#define AT25SL128_POWER_UP_DELAY_US           10000 // tVSL/tVCSL  tPUV?

__RETAINED_CODE static void oqspi_at25sl128_initialize(HW_OQSPI_BUS_MODE bus_mode, sys_clk_t sys_clk);

static const oqspi_flash_config_t oqspi_at25sl128_cfg = {
    .jedec.manufacturer_id = OQSPI_ADESTO_QUAD_MANUFACTURER_ID,
    .jedec.type            = OQSPI_ADESTO_QUAD_AD25SLXXX_TYPE,
    .jedec.density         = OQSPI_AT25SL128_DENSITY,
    ...
    .read_instr_cfg.cs_idle_delay_nsec  = AT25SL128_READ_CS_IDLE_DELAY_NS,
    ...
    .erase_instr_cfg.cs_idle_delay_nsec = AT25SL128_ERASE_CS_IDLE_DELAY_NS,
    ...
    .suspend_resume_instr_cfg.suspend_latency_usec = AT25SL128_SUSPEND_LATENCY_US,
    .suspend_resume_instr_cfg.resume_latency_usec  = AT25SL128_RESUME_LATENCY_US,
    .suspend_resume_instr_cfg.res_sus_latency_usec = AT25SL128_RES_SUS_LATENCY_US,
    ...
    .delay.reset_usec              = AT25SL128_RESET_DELAY_US,
    .delay.power_down_usec         = AT25SL128_POWER_DOWN_DELAY_US,
    .delay.release_power_down_usec = AT25SL128_RELEASE_POWER_DOWN_DELAY_US,
    .delay.power_up_usec           = AT25SL128_POWER_UP_DELAY_US,

    .callback.initialize_cb       = oqspi_at25sl128_initialize,
