...
def program_bin_qspi(bin_file, bin_address, cli_programmer, serial=None, check_booter_load=True):

    if bin_file is not None:
        ui.print_title("Programming image")

    cli_programmer.write_qspi(bin_address, bin_file,
...
if __name__ == '__main__':
    ...
    run_script(program_bin_qspi, parse_args)
